# Generated by Django 5.2.7 on 2025-10-07 07:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('customer', 'Customer'), ('admin', 'Admin'), ('owner', 'Owner')], default='customer', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'รอดำเนินการ'), ('shipped', 'จัดส่งแล้ว'), ('cancelled', 'ยกเลิก')], default='pending', max_length=50)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('method', models.CharField(choices=[('credit_card', 'credit_card'), ('transfer', 'transfer'), ('cash', 'cash')], max_length=50)),
                ('status', models.CharField(choices=[('pending', 'รอการยืนยัน'), ('success', 'สำเร็จแล้ว'), ('cancelled', 'ยกเลิก')], max_length=50)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
